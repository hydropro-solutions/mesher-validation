...
![DTC midship slice](cases/dtc/images/dtc_midship_slice.png)
...
![Ahmed symmetry-plane slice](cases/ahmed25/images/ahmed_slice_symmetry_y0.png)
...
Each case directory contains the detailed validation notes, numerical results, figures, and links to the corresponding downloadable OpenFOAM case.
...
The automated 3D meshing technology presented here is being developed as part of HydroPro's engineering software activities, with an initial focus on demanding CFD applications and marine hydrodynamics.

---

## Status

The current meshing system has reached a frozen MVP stage.

The present validation campaign is focused on documenting its capabilities, expanding the public validation database, and preparing the technology for selected engineering applications.
